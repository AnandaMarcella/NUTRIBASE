...
<style>
    ...
    .ct-blob-1 {
        ...
        animation: ctBlob1 9s ease-in-out infinite;
    }
    ...
    .ct-blob-2 {
        ...
        animation: ctBlob2 12s ease-in-out infinite;
    }
    ...
    .info-icon i { color: var(--leaf); font-size: 19px; }
    ...
    /* Highlighted card */
    .info-card-highlight {
        background: linear-gradient(135deg, rgba(22,163,74,0.08), rgba(74,222,128,0.1));
    ...
    .wa-card:hover {
        box-shadow: 0 32px 80px rgba(22,163,74,0.14);
    ...
    .wa-card:hover .wa-icon-wrapper { transform: scale(1.08) rotate(-3deg); }

    @keyframes iconPulse {
        0%, 100% { box-shadow: 0 12px 40px rgba(37,211,102,0.3); }
        50% { box-shadow: 0 16px 52px rgba(37,211,102,0.45); }
    }

    .wa-icon-wrapper i { font-size: 42px; color: white; }
    ...
    .wa-divider-line { flex: 1; height: 1px; background: rgba(22,163,74,0.12); }
    .wa-divider span { font-size: 12px; color: var(--sage); font-weight: 600; }
